...
public class DiverRenderer {
    ...
    private final int vertexCount = diverCoords.length / COORDS_PER_VERTEX;
    ...
    public DiverRenderer(Diver diver) {
        ...
        ByteBuffer bb = ByteBuffer.allocateDirect(diverCoords.length * 4);
        bb.order(ByteOrder.nativeOrder());
        vertexBuffer = bb.asFloatBuffer();
        vertexBuffer.put(diverCoords);
